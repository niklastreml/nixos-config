...
- **Format:** Write in a narrative flow. Use task-oriented section headings that describe _what the reader accomplishes_ (e.g., `## Create the pipeline configuration`, not `### Step 1`).
...
- State the facts clearly. Use lists and strict formatting. Use tables _only_ for truly tabular data.
...
**Intent:** The user wants to understand _why_ something is the way it is, or how a system works conceptually.
